...
def app
  ...
  # p  Postcard.new('Greetings from Silicon Valley!')
  # puts  Postcard.new('Greetings from Silicon Valley!')
  # return
...
# #<PostalService:0x00007f88a998aa60 @account_number=nil, @mailbox=[], @name="John", @street_address="47 Sunshine Ave.">
